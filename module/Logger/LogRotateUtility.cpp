...
#define AOI_FIBER_MODIFIED_LOGROTATEUTILITY_CPP

#ifdef AOI_FIBER_MODIFIED_LOGROTATEUTILITY_CPP
#include "LogRotateUtility.h"
#else
...
#ifdef AOI_FIBER_MODIFIED_LOGROTATEUTILITY_CPP
      std::filesystem::path out_dir = std::filesystem::path(complete_file_with_path).parent_path();
